...
public class MainActivity extends AppCompatActivity {
    /* definindo o btnViewNavigation como atributo para utilizalo como referencia em outros metodos*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* obtendo referencia para MainViewModel*/
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                /* guardando dentro do view model a opcao escolhida pelo usuario*/
                vm.setNavigationOpSelected(item.getItemId());
                switch (item.getItemId()){
                    /* criando e setando fragmentos de acordo com o que foi escolhido pelo usuario*/
    ...
    /* o metodo recebe como parametro um fragmento que vai ser setado no espaco definido pelo fragContainer
     * se inicia uma transacao com o gerenciador o fragmento é substituido e é feito um commit da transacao*/
